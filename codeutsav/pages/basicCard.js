...
const BasicCard = () => {
  ...
  const handleClick = () => {
    ...
    axios({
      method: "post",
      url: "https://ehr-0f78.onrender.com/api/doctor",
      data: {
        ehr: Object,
  ...
  return (
    <div className="maines">
      ...
      <div className="containers">
        <div className="headi">Add a new Patient</div>
        <br></br>
        <div className="tab">
          <CheckoutWizard activeStep={m} />
        </div>
        ...
        <div className="form">
          <div className="ls">
            ...
            <div className="ln">
              ...
              <input
                placeholder="Records of hospitalization"
            ...
            <div className="an">
              ...
              <input
                placeholder="Conditions or Diseases"
                name="diseases"
                autoComplete="off"
                onChange={(event) => {
            ...
            <div className="ln">
              Surgeries Performed
              <input
                placeholder="Surgeries Performed"
                name="surgeries"
                autoComplete="off"
                type="number"
          ...
          <div className="rs">
            ...
            <div className="ln">
              Immune status
              <input
                placeholder="Immunisation status (out of 10)"
                name="visits"
                autoComplete="off"
